...
# mri_aparc2aseg --s bert --volmask --aseg aseg.presurf.hypos --annot aparc.DKTatlas --o mri/aparc.DKTatlas_plus_aseg.mgz
...
requirements:
  ...
  - class: InitialWorkDirRequirement
    ...
    - entry: $(inputs.lh_aparc_DKTatlas_annot)
      entryname: $(runtime.outdir + "/" + inputs.subname + "/label/" + "lh.aparc.DKTatlas.annot")
    - entry: $(inputs.rh_aparc_DKTatlas_annot)
      entryname: $(runtime.outdir + "/" + inputs.subname + "/label/" + "rh.aparc.DKTatlas.annot")
...
inputs:
  ...
  annot:
    type: string
    default: aparc.DKTatlas
    inputBinding:
      position: 4
      prefix: --annot
  output_filename:
    type: string
    default: "aparc.DKTatlas_plus_aseg.mgz"
    inputBinding:
      position: 5
      prefix: --o
  ribbon:
    type: File
  lh_aparc_DKTatlas_annot:
    type: File
  rh_aparc_DKTatlas_annot:
    type: File
  lh_white:
    type: File
  rh_white:
